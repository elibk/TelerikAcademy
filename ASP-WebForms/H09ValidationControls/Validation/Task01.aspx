<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Task01.aspx.cs" Inherits="Validation.Task01" %>

<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">

     <asp:ValidationSummary 
        ID="ValidationSummaryForm" runat="server" CssClass="text-error"
    ...
    <div class="form-horizontal" runat="server" id="formForLogin">
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <asp:Button runat="server" ID="SendData" CssClass="btn btn-large" Text="Sign in" CausesValidation="true" OnClick="Submit_Click" />
            </div>
        </div>
    </div>
     ...
     <asp:RequiredFieldValidator 
         ...
         ErrorMessage="The Field Password Repeat is required.<br/>"/>
    ...
    <asp:RegularExpressionValidator
        ...
        ErrorMessage="The Email must be in format 'some@mail.bg'.<br/>"/>
      ...
      <asp:RequiredFieldValidator 
         ...
         ErrorMessage="The Field Local Address is required.<br/>"/>
     ...
     <asp:RegularExpressionValidator
        ...
        ErrorMessage="The Phone must be in format '(000)000-0000'.<br/>"/>
