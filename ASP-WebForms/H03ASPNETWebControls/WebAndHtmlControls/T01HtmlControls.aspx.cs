...
{
    public partial class T01HtmlControls : System.Web.UI.Page
    {
        ...
        protected void ButtonGenerateRandom_Click(object sender, EventArgs e)
        {
            ...
            int firstNumber;
            int secondNumber;
            bool isFirstNumber = int.TryParse(this.minValue.Text, out firstNumber);
            bool isSecondNumber = int.TryParse(this.maxValue.Text, out secondNumber);
